...
public class CompleteDaoJdbc implements CompleteDao {
  ...
  public CompleteDaoJdbc(String connectionString) {
    this(connectionString, null, null);
  }

  public CompleteDaoJdbc(String connectionString, String userName, String password) {
...
*/
  ...
  public void close() throws Exception {
    try {
      ...
      throw new DataAccessException(
          "Problems closing database connection: SQLException: "
              + ex.getMessage());
    } // catch
  }
